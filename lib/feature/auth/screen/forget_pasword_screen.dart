...
class ForgetPaswordScreen extends StatelessWidget {
  ...
  Widget _buildTopSection(ForgetPaswordController controller) {
    return Padding(
  ...
  Widget _buildSubtitle() {
    return Column(
      children: [
        headingText(text: "Forget Password", color: Colors.white),
        SizedBox(height: 8.h),
        smallText(
            textAlign: TextAlign.center,
            text:
                'Enter your email here. \nGive valid email to reset your password',
            maxLines: 2)
      ],
    );
  }

  Widget _buildEmailField(ForgetPaswordController controller) {
    return Obx(
      () => Container(
        decoration: BoxDecoration(
  ...
  Widget _buildLoginButtonWithCustomSplash(ForgetPaswordController controller) {
    return Obx(
      () => Container(
        width: double.infinity,
        height: 54.h,
